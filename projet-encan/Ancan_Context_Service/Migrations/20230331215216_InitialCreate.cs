        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BiddingPrice = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Biddings_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Biddings_Items_ItemID",
                        column: x => x.ItemID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Biddings_ClientId",
                table: "Biddings",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_Biddings_ItemID",
                table: "Biddings",
                column: "ItemID");
        }
